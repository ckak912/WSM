        ...
        <>
            ...
            <div className="flex justify-center items-center mt-8 w-full bg-white py-12 lg:py-24 bg-gray-200">
                ...
                <form onSubmit={sendEmail}>
                    ...
                    <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl mt-20">
                        <div className="flex">
                        ...
                        <div
                            ...
                            <div className="flex flex-col text-white">
                                ...
                                <div className="flex my-4 w-2/3 lg:w-3/4">
                                    ...
                                    <div className="flex flex-col">
                                        <h2 className="text-2xl">Located at:</h2>
                                        <p className="text-gray-400">1 Wynyard Street, Devonport, Auckland</p>
                                    </div>
                                </div>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <p className="text-gray-400">Tel: 09 445 1357</p>
                        
                            <div className='mt-5'>
                                <h2 className="text-2xl">Send an E-mail</h2>
                                <p className="text-gray-400">aaron@ambro.co.nz</p>
                            </div>
