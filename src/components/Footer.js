        ...
        <footer>
            <div className="footer max-w-full mx-auto px-4 sm:px-6 bg-gray-100 border-t border-b py-30">
                <div className="text-center flex flex-col items-center justify-center">
                    <img src={mtaAssuredImage} alt="MTA Assured" className="w-16 h-auto mb-2 mt-4" />
                    <h3 className="font-bold text-black-150 text-2xl mb-2">Wynyard Street Motors – MTA Registered</h3>
